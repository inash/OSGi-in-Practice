...
public class ScannerMailboxTracker extends ServiceTracker {
	...
	public ScannerMailboxTracker(BundleContext context, JTabbedPane tabbedPane) {
	...
	public Object addingService(ServiceReference reference) {
		final String mboxName = (String) reference.getProperty(Mailbox.NAME_PROPERTY);
		...
		FutureTask<MailboxPanel> future = new FutureTask<>(callable);
